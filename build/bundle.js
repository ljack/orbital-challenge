...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.push([module.id, ":root{--mainColor:#fbaff}@custom-media --mobile (width <= 640px);@custom-selector --heading h1,h2,h3,h4,h5,h6;main --heading{text-rendering:optimizeLegibility;color:color(var(--mainColor) blackness(+20%))}@media(--mobile){--heading{margin-top:0}}", ""]);
